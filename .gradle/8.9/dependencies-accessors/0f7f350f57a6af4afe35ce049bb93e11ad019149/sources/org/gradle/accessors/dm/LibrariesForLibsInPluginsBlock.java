...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>chuckerRelease</b> with <b>com.github.chuckerteam.chucker:library-no-op</b> coordinates and
     * with version reference <b>chucker</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>retrofit</b> with <b>com.squareup.retrofit2:converter-moshi</b> coordinates and
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>material2</b> with <b>com.google.android.material:material</b> coordinates and
         * with version reference <b>material2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class MoshiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>moshiCodegen</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ToolingVersionAccessors vaccForToolingVersionAccessors = new ToolingVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>material2</b> with value <b>1.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial2() { return getVersion("material2"); }
        ...
        /**
         * Version alias <b>moshiCodegen</b> with value <b>1.15.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMoshiCodegen() { return getVersion("moshiCodegen"); }
        ...
        /**
         * Group of versions at <b>versions.tooling</b>
         */
        public ToolingVersionAccessors getTooling() {
            return vaccForToolingVersionAccessors;
        }

    }

    public static class ToolingVersionAccessors extends VersionFactory  {

        public ToolingVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>tooling.preview</b> with value <b>1.4.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPreview() { return getVersion("tooling.preview"); }
    ...
    public static class KspPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>ksp.devtool</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getDevtool() { return createPlugin("ksp.devtool"); }
